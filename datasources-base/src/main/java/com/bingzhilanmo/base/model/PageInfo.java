package com.bingzhilanmo.base.model;
...
public class PageInfo<T> implements Serializable {
	...
	public Map<String, Object> getParams() {
		return (Map<String, Object>) (params == null ? Collections.emptyMap() : params);
	}
	...
	public Map<String, Object> getResult() {
		return (Map<String, Object>) (result == null ? Collections.emptyMap() : result);
	}
	...
	public Integer getTotalPage(Integer totalRecords){
		Integer totalPage=totalRecords/pageSize;
